...
**Twitter Application** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] User can reply, retweet, favorite, unfavorite a tweet through these sections:
   * [x] Home Timeline
   * [x] Mention Timeline
   * [x] User Timeline
...
- [PrettyTime](http://www.ocpsoft.org/prettytime/) - PrettyTime is an OpenSource time formatting library
