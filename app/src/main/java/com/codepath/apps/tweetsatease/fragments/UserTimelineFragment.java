        ...
        extends TweetsListFragment
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (Helper.isInternetConnected(getActivity().getApplicationContext())) {
            fetchUserTimeline(getActivity().findViewById(android.R.id.content));
        ...
        setUpUserTimelineListeners(mSwipeContainer);
    }



    public void setUpUserTimelineListeners(final SwipeRefreshLayout mSwipeContainer) {
